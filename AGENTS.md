<!-- dox-managed:v2 -->
# RokuLightningJS Repository Contract

## Core Contract

- This file is the root work contract for `dominick253/RokuLightningJS`.
...
- Default branch: `main`
- Primary toolchains: Mixed or documentation-only
- Visibility: public
...
| Path | Purpose |
|---|---|
| `LICENSE` | Root project file or artifact. |
| `README.md` | Root project file or artifact. |
| `_config.yml` | Root project file or artifact. |
